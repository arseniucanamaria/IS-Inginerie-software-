...
<center><b><i><u><font size="10" color = "Red " > Anuntul pe care doresti sa il adaugi:</font></u></i></b></center>
 <br>
 <br>
 <br><br>
<font size="5" align=right>
 <form  action = "adaugare_anunturi.php" method="post">
    <p>
...
$sql = "INSERT INTO anunt (titlu, mesaj) VALUES ( '$titlu', '$mesaj')";
...
print 'alert ("Anuntul a fost adaugat!")';
print '</script>';
