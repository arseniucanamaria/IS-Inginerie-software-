...
$sql = "INSERT INTO rute (oras_plecare, oras_sosire, ora_plecare, ora_sosire, durata, pret) VALUES ( '$oras_plecare', '$oras_sosire', '$ora_plecare', '$ora_sosire', '$durata', '$pret')";
...
print 'alert ("Datele au fost inserate cu succes!")';
print '</script>';
