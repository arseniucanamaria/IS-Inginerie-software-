...
<center><b><i><u><font size="10" color = "Red " > Anuntul pe care doresti sa il stergi:</font></u></i></b></center>
 <br>
 <br>
 <br><br>
<font size="5" align=right>
 <form  action = "anunturi_stergere_site.php" method="post">
 <p>
        <label for="mesaj">Id:</label>
        <input type="text" name="id" id="id">
    </p>
   

<input type="button" onclick="location.href ='anunturi_stergere_site.php'" value="Sterge anunt"></div><br><br><br><br><br>

</form>

	  
<button onclick="goBack()">Inapoi</button>
...
$link = mysqli_connect("localhost", "root", "", "anunt");
...
print 'alert ("Anuntul ales a fost sters cu succes")';
print '</script>';
