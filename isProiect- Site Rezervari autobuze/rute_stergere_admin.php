...
<body>
  ...
  <button class="tablinks" onclick="location.href='harti.php'">Harti</button>
      ...
      <h1>Auto-Bus - stergere rute </h1><br><br>
	  
	  <form  action = "rute_stergere_admin.php" method="post">
    <p>
        <label for="oras_plecare">oras_plecare:</label>
        <input type="text" name="oras_plecare" id="oras_plecare">
    </p>
    <p>
        <label for="oras_sosire">oras_plecare:</label>
	...
	<input type = "submit" name = "submit"  value= "Stergere">
</form>
...
$sql = "DELETE FROM rute WHERE  oras_plecare = '$oras_plecare' AND oras_sosire = '$oras_sosire' AND ora_plecare = '$ora_plecare' AND ora_sosire = '$ora_sosire'";
...
print 'alert ("Ruta aleasa a fost stearsa cu succes")';
print '</script>';
